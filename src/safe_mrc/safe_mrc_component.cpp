...
MRCComponent::MRCComponent(RS485Serial& rs485_serial,
                           std::shared_ptr<BusDiagnostics> diagnostics)
    : SafeMRCDeviceCollection(rs485_serial, diagnostics) {}

void MRCComponent::init_mrc_devices(std::vector<MRCType> mrc_types,
