...
public:
    ...
    RS485DeviceColllection& get_master_rs485_device_collection() {
...
private:
    ...
    std::unique_ptr<RS485DeviceColllection> master_rs485_device_collection_;
    std::vector<SafeMRCDeviceCollection*> sub_mrc_device_collections_;
    void register_mrc_device_collection(SafeMRCDeviceCollection& device_collection);
